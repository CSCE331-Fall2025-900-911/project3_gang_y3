...
export default function ItemCard({ item, onAdd }: { item: Item; onAdd: (it: Item) => void }) {
  ...
  return (
    <div className="border border-gray-200 dark:border-gray-600 rounded p-3 flex flex-col bg-white dark:bg-zinc-700 transition-all duration-200 hover:shadow-lg hover:-translate-y-1 hover:scale-[1.03]">
